<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/do_login|template/default/header|template/default/common_header|template/default/footer|template/default/header', '1340553945', 'template/default/do_login');?><?php $_TPL['nosidebar']=1; ?>
...
<div class="heder">
<div class="henr">
<div class="logo"><a href="<?php echo usr_url('index') ?>"><img alt="狗咆" src="<?=$_USER_SC['domain']?>images/logo.png" /></a></div>
        <div class="menu">
            <ul>
                <?php if($_SERVER['REQUEST_URI'] == '/home/' . usr_url('index')) { ?>
                <li><a href="<?php echo usr_url('index') ?>"><img alt="首页" src="<?=$_USER_SC['domain']?>images/home.gif" /></a></li>
                <?php } else { ?>
                <li><a href="<?php echo usr_url('index') ?>"><img alt="首页" src="<?=$_USER_SC['domain']?>images/sy.png" /></a></li>
                <?php } ?>
                <?php if($_SERVER['REQUEST_URI'] == '/home/' . usr_url('network')) { ?>
                <li><a href="<?php echo usr_url('network') ?>"><img alt="广场" src="<?=$_USER_SC['domain']?>images/gc.gif" /></a></li>
                <?php } else { ?>
                <li><a href="<?php echo usr_url('network') ?>"><img alt="广场" src="<?=$_USER_SC['domain']?>images/gc.png" /></a></li>
                <?php } ?>
                <?php if($_SERVER['REQUEST_URI'] == '/home/' . usr_url('space', array('do'=>'mtag'))) { ?>
                <li><a href="<?php echo usr_url('space', array('do'=>'mtag')) ?>"><img alt="圈子" src="<?=$_USER_SC['domain']?>images/qz.gif" /></a></li>
                <?php } else { ?>
                <li><a href="<?php echo usr_url('space', array('do'=>'mtag')) ?>"><img alt="圈子" src="<?=$_USER_SC['domain']?>images/qz_index.png" /></a></li>
                <?php } ?>
                <?php if($_SERVER['REQUEST_URI'] == '/home/' . usr_url('space', array('do'=>'event'))) { ?>
                <li><a href="<?php echo usr_url('space', array('do'=>'event')) ?>"><img alt="活动" src="<?=$_USER_SC['domain']?>images/hd.gif" /></a></li>
                <?php } else { ?>
                <li><a href="<?php echo usr_url('space', array('do'=>'event')) ?>"><img alt="活动" src="<?=$_USER_SC['domain']?>images/hd.png" /></a></li>
                <?php } ?>
            </ul>
        </div>
        <div class="mime">
        	<ul>
                <li><a href="<?php echo usr_url('space', array('do'=>'blog')) ?>">日志</a></li>
                <li><a href="<?php echo usr_url('space') ?>">空间</a></li>
                <li><a href="<?php echo usr_url('space', array('do'=>'album')) ?>">相册</a></li>
                <li><a href="<?php echo usr_url('space', array('do'=>'mtag')) ?>">部落</a></li>
            </ul>
        </div>
    </div>
</div>
...
<div class="content">
    	<ul class="xx">
            <li><a href="<?php echo usr_url('do', array('ac'=>$_SCONFIG['register_action'])) ?>"><img src="<?=$_USER_SC['domain']?>images/yhzc.png" /></a></li>
            <li><a href="<?php echo usr_url('do', array('ac'=>$_SCONFIG['login_action'])) ?>"><img src="<?=$_USER_SC['domain']?>images/yhdl.png" /></a></li>
            <li><a href="<?php echo usr_url('do', array('ac'=>'lostpasswd')) ?>"><img src="<?=$_USER_SC['domain']?>images/wjmm.png" /></a></li>
        </ul>
        <div class="zcnr">
            <div class="zcxq">
                <form id="loginform" name="loginform" action="<?php echo usr_url('do', array('ac'=>$_SCONFIG[login_action], $url_plus, 'ref')) ?><?=$url_plus?>" method="post" class="c_form">
                <?php if($invitearr) { ?>
<a href="<?php echo usr_url('space', $url_plus) ?>" target="_blank"><?php echo avatar($invitearr[uid],small); ?></a>
<a href="<?php echo usr_url('space', $url_plus) ?>" target="_blank"><?=$_SN[$invitearr['uid']]?></a>
                <?php } ?>
...
<?php } ?>
<?php } ?>
    <ul><?php if($_SGLOBAL['input_seccode']) { ?>
        <?php } else { ?>
        <li><b>用户名</b><div class="rizc"><input class="tx" type="text" name="username" /><p>请输入常用邮箱，作为登录帐号</p></div></li>
        <li><b>密　码</b><div class="rizc"><input class="tx" type="password" name="password" tabindex="3" /><p>请输入常用邮箱，作为登录帐号</p></div></li>
        <li><b>自动登录</b><div class="rizc" style="line-height:22px;"><input type="checkbox" id="cookietime" name="cookietime" value="315360000" <?=$cookiecheck?> style="margin-bottom: -2px;"><p></p></div></li>
        <?php } ?>
        <li><b>&nbsp;</b><div class="rizc">
            <input class="tjan"  id="loginsubmit" name="loginsubmit" type="submit" />
            <input type="hidden" name="refer" value="<?=$refer?>" />
        </div></li>
        <li><b>邮箱</b><div class="rizc"><input class="tx" type="text" /><p>请输入常用邮箱，作为登录帐号</p></div></li>
        <li><b>密码</b><div class="rizc"><input class="tx" type="text" /><p>6-16位字符，注意区分大小写</p></div></li>
        <li><b>确认密码</b><div class="rizc"><input class="tx" type="text" /><p>请输入重复密码</p></div></li>
        <li><b>昵称</b><div class="rizc"><input class="tx" type="text" /></div></li>
        <li><b>验证码</b><div class="rizc"><input class="yzm" type="text" /><img src="<?=$_USER_SC['domain']?>images/yzm.gif" /><a href="#">换一换</a></div></li>
        <li><b>&nbsp;</b><div class="rizc"><input type="checkbox" />我已阅读并同意遵守《gopo.cc服务条款》</div></li>
        <li><b>&nbsp;</b><div class="rizc"><input class="zca" type="button" /></div></li>
    </ul>
...
var x = new Ajax('XML', objname);
        x.get('<?php echo usr_url('do', array('ac'=>$_SCONFIG[register_action])) ?>' + data, function(s){
var obj = $(objname);
s = trim(s);
