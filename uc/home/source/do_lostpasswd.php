...
if(submitcheck('lostpwsubmit')) {
	...
	$idstring = random(6);
	$reseturl = usr_url('do', array('ac'=>'lostpasswd', 'op'=>'reset', 'uid'=>$spaceinfo['uid'], 'id'=>$idstring));
	...
	showmessage('getpasswd_send_succeed', usr_url('do', array('ac'=>$_SCONFIG['login_action']), 5));
