...
define('UC_DBPW', '');
define('UC_DBNAME', 'gopo');
define('UC_DBCHARSET', 'utf8');
define('UC_DBTABLEPRE', '`gopo`.uc_');
define('UC_DBCONNECT', '0');
define('UC_KEY', 'w7U5B18ev84dL8mbp9T7K8T0M8b8J7xct8M3Mb50P4pbM7H3E8FeR1DaicW5Y1m3');
define('UC_API', 'http://www.gopo.com/ucenter');
define('UC_CHARSET', 'utf-8');
define('UC_IP', '192.168.0.10');
define('UC_APPID', '2');
define('UC_PPP', '20');